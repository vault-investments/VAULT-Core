...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* VAULT features */
        {"vault", "masternode", &masternode, true, true, false},
        {"vault", "listmasternodes", &listmasternodes, true, true, false},
        {"vault", "getmasternodecount", &getmasternodecount, true, true, false},
        {"vault", "masternodeconnect", &masternodeconnect, true, true, false},
        {"vault", "masternodecurrent", &masternodecurrent, true, true, false},
        {"vault", "masternodedebug", &masternodedebug, true, true, false},
        {"vault", "startmasternode", &startmasternode, true, true, false},
        {"vault", "createmasternodekey", &createmasternodekey, true, true, false},
        {"vault", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"vault", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"vault", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"vault", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"vault", "getmasternodescores", &getmasternodescores, true, true, false},
        {"vault", "mnbudget", &mnbudget, true, true, false},
        {"vault", "preparebudget", &preparebudget, true, true, false},
        {"vault", "submitbudget", &submitbudget, true, true, false},
        {"vault", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"vault", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"vault", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"vault", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"vault", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"vault", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"vault", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"vault", "checkbudgets", &checkbudgets, true, true, false},
        {"vault", "mnsync", &mnsync, true, true, false},
        {"vault", "spork", &spork, true, true, false},
        {"vault", "getpoolinfo", &getpoolinfo, true, true, false},
#ifdef ENABLE_WALLET
        {"vault", "obfuscation", &obfuscation, false, false, true}, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use vaultd, or the -server option to vault-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
