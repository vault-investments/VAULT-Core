...
void setupAddressWidget(QValidatedLineEdit* widget, QWidget* parent)
{
    ...
    widget->setPlaceholderText(QObject::tr("Enter a VAULT address (e.g. %1)").arg("VDEVXXjKFMrdimYyMd5HrsHfnACGknCS5Q"));
#endif
...
void openConfigfile()
{
    ...
    /* Open vault.conf with the associated application */
