                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("VAULT Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a VAULT address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and vault: URIs)"));
    ...
    privacyAction->setStatusTip(tr("Privacy Actions for zVAULT"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About VAULT Core"), this);
    aboutAction->setStatusTip(tr("Show information about VAULT Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for VAULT"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your VAULT addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified VAULT addresses"));
    ...
    openAction->setStatusTip(tr("Open a VAULT: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the VAULT Core help message to get a list with possible VAULT command-line options"));
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to VAULT network", "", count));
}
