...
VAULT Core version *version* is now available from:

  <https://github.com/vault-investments/VAULT-Core/releases>

Please report bugs using the issue tracker at github:

  <https://github.com/vault-investments/VAULT-Core/issues>
