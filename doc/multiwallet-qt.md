...
In order to support loading of multiple wallets in vault-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is vault.cpp.
...
Changes to vault.cpp
----------------------
vault.cpp is the entry point into vault-qt, and as such, will require some minor modifications to provide hooks for
