...
RESOURCES += src/qt/vault.qrc src/qt/vault_locale.qrc

TRANSLATIONS += src/qt/locale/vault_bg.ts \
                src/qt/locale/vault_de.ts \
                src/qt/locale/vault_en.ts \
                src/qt/locale/vault_es.ts \
                src/qt/locale/vault_fi.ts \
                src/qt/locale/vault_fr.ts \
                src/qt/locale/vault_it.ts \
                src/qt/locale/vault_ja.ts \
                src/qt/locale/vault_pl.ts \
                src/qt/locale/vault_pt.ts \
                src/qt/locale/vault_ru.ts \
                src/qt/locale/vault_sk.ts \
                src/qt/locale/vault_sv.ts \
                src/qt/locale/vault_vi.ts \
                src/qt/locale/vault_zh_CN.ts \
                src/qt/locale/vault_zh_TW.ts
