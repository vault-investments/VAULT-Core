...
TMP_FOLDER=$(mktemp -d)
CONFIG_FILE='vault.conf'
CONFIGFOLDER='/root/.vault'
COIN_DAEMON='vaultd'
COIN_CLI='vault-cli'
COIN_PATH='/usr/local/bin/'
COIN_REPO='https://github.com/vault-investments/VAULT-Core.git'
COIN_TGZ=https://github.com/vault-investments/VAULT-Core/releases/download/v1.0.0.0/vault-1.0.0.0-x86_64-linux-gnu.zip'
...
#ADDNODES
addnode=45.32.145.142:14147
addnode=95.179.200.213:14147
addnode=45.63.10.156:14147
addnode=144.202.53.246:14147
addnode=104.207.130.217:14147
addnode=45.77.5.22:14147
addnode=5.189.161.64:14147
addnode=173.249.8.46:14147
EOF
}
